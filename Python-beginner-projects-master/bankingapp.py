...
def register():
    ...
    # Buttons
    Button(register_screen, text="Register", bg='light blue', command=finish_reg, font=('Calibri', 12)).grid(row=5, sticky=N, pady=10)
    ...
    for name in all_accounts:
        if name == login_name:
            ...
            if login_password == password:
                ...
                #Buttons
                Button(account_dashboard, text="Personal Details", bg='light blue', font=('Calibri', 12), width=30, command=personal_details).grid(row=2,sticky=N,padx=10)
                Button(account_dashboard, text="Deposit",bg='light blue', font=('Calibri', 12), width=30, command=deposit).grid(row=3, sticky=N,padx=10)
                Button(account_dashboard, text="Withdraw", bg='light blue', font=('Calibri', 12), width=30, command=withdraw).grid(row=4, sticky=N, padx=10)
